    ...
    init: function() {
      ...
      $('body').on('ajax:success', '.mobile .event-action', this.closeEvent({
        onLeave: function(index, nextIndex, direction) {
          ...
          return $($('.circle')[nextIndex - 1]).addClass('active');
        }
      }));
      this.switchText();
      this.bounceFeedback();
...
(function() {
  ...
  MobileEvents = {
    ...
    liftFilter: function() {
      ...
      return $('.filter-container').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function() {
        return $(this).hide();
      });
    },
    showFilters: function() {
      return $('.filter-container').show().removeClass('animated bounceOutUp').addClass('animated bounceInDown');
    },
