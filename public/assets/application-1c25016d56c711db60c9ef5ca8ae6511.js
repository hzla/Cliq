...
(function() {
  ...
  Events = {
    init: function() {
      ...
      $('body').on('click', '#invites .form-row .event-type', this.filterEvents);
      $('body').on('click', '.filter-container .form-row .event-type', this.filterEvents);
      $('body').on('click', '#invites .form-row .event-attr', this.filterEvents);
      $('body').on('click', '.filter-container .form-row .event-attr', this.filterEvents);
      return $('body').on('click', '.event-filter', this.bigFilter);
    },
    bigFilter: function() {
      if ($('.mobile').length > 0) {
...
(function() {
  ...
  MobileUsers = {
    init: function() {
      ...
      return $('body').on('ajax:success', '.profile-actions form, #cat-header-content form', this.feedback);
    },
    feedback: function() {
      var fb;
      console.log("tried");
...
(function() {
  ...
  Animations = {
    ...
    showLabel: function(e) {
      $(this).find('.icon-label').css('opacity', '1');
      $(this).stop().animate({
        width: "210px"
      }, 200);
  ...
  Users = {
    ...
    closeWelcome: function() {
      if ($('#email').val().slice(-7) === "ucf.edu") {
        $('.welcome-form').submit();
        return $('#activation-container').remove();
      } else {
    ...
    openFeedback: function() {
      ...
      return $('#feedback-message').hide().show().text('Have any suggestions for Cliq? Feel free to send us some feedback!');
    },
