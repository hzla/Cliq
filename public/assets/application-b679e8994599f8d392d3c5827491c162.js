...
(function() {
  ...
  Events = {
    init: function() {
      ...
      $('body').on('click', '.filter-container .form-row div:not(#new-open-event)', this.filterEvents);
    ...
    filterEvents: function() {
      ...
      $('.date-header').hide();
      return $('.date-header').parent().has(":visible").children(".date-header").show();
    },
    send: function() {
...
(function() {
  ...
  EventForm = {
    init: function() {
      ...
      return $('body').on('click', '.event-requirement', this.chooseRequirement);
    },
    chooseType: function() {
      var selected, type;
...
(function() {
  ...
  MobileMessages = {
    ...
    swipeToConvo: function() {
      ...
      return $('#thread-container').removeClass().addClass('animated fadeInRightBig');
    },
